The goal of the AirBnB clone project is to deploy on my server a simple copy of the AirBnB website. The AirBnB clone project will not implement all the features
