...
class TestBaseModelDocs(unittest.TestCase):
    """Tests to check the documentation style of BaseModel class"""
    ...
    def test_module_docstring(self):
        ...
        self.assertIsNot(mdoc, None, "base_model.py has no docstring")
        self.assertTrue(len(mdoc) > 1, "base_model.py has no docstring")
